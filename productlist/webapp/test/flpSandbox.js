		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Products List",
									"targetURL": "#productslistproductlist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"productslistproductlist-display": {
								"semanticObject": "productslistproductlist",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=productslist.productlist",
									"url": sap.ui.require.toUrl("productslist/productlist")
								}
							}
						}
					}
